...
## A camera system that allows the camera to go left, right, up, and down
##
## Including a clamping system to prevent flipping and Controller support
##

# Adjustable sensitivity values
