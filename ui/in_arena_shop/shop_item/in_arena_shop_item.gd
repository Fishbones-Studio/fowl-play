...
func _buy_upgrade() -> void:
	...
	if upgrade_item.health_bonus > 0:
		GameManager.chicken_player.max_health += upgrade_item.health_bonus
		GameManager.chicken_player.health += upgrade_item.health_bonus  

	if upgrade_item.stamina_bonus > 0:
		GameManager.chicken_player.max_stamina += upgrade_item.stamina_bonus
		GameManager.chicken_player.stamina += upgrade_item.stamina_bonus 
